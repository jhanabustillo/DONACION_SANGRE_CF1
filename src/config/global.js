export const global = {
  ...
  descripcionCurso:
    'En el presente componente, el aprendiz podrá identificar la normatividad asociada con el área de promoción de la donación voluntaria y habitual de sangre, incluida la revisión de los lineamientos y boletines técnicos publicados a nivel nacional. De esta manera, quienes deseen desempeñar funciones en promoción de la donación de sangre, podrán conocer los criterios establecidos al respecto, su fundamentación y contribución al fortalecimiento de la seguridad transfusional. Dada la relevancia de la documentación para poder demostrar que se está cumpliendo con los criterios normativos establecidos, además de ser el pilar fundamental para que cada proceso sea trazable, en este componente también se abordarán algunos aspectos relacionados con la gestión documental en el área de promoción de la donación de sangre. Por otro lado, el aprendiz también logrará identificar cómo está constituida la red de sangre en Colombia y cuál es la función que cumple cada uno de los actores que la conforman. Además, se dará a conocer cómo se llevan a cabo los mecanismos de respuesta ante necesidades de hemocomponentes en aquellas situaciones de emergencia, desastre o posible desastre. Por último, se revisarán algunos criterios relacionados con la selección de los donantes.',
